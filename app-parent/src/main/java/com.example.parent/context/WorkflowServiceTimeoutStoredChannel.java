...
public class WorkflowServiceTimeoutStoredChannel extends WorkflowServiceTChannel {
  ...
  Functions.Func1<TException, Void> callback;

  public void setCallbackOnError(Functions.Func1<TException, Void> callback) {
  ...
  private void checkException(TException e) {
    if (e instanceof TTransportException
        && ((TTransportException) e).getType() == TTransportException.TIMED_OUT) {
      callback.apply(e);
